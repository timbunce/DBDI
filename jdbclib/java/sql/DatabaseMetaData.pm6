...
role java::sql::DatabaseMetaData does java::sql::Wrapper  {
    ...
    method procedureResultUnknown (--> Int) is export { ... }
    method procedureNoResult (--> Int) is export { ... }
    method procedureReturnsResult (--> Int) is export { ... }
    method procedureColumnUnknown (--> Int) is export { ... }
    method procedureColumnIn (--> Int) is export { ... }
    method procedureColumnInOut (--> Int) is export { ... }
    method procedureColumnOut (--> Int) is export { ... }
    method procedureColumnReturn (--> Int) is export { ... }
    method procedureColumnResult (--> Int) is export { ... }
    method procedureNoNulls (--> Int) is export { ... }
    method procedureNullable (--> Int) is export { ... }
    method procedureNullableUnknown (--> Int) is export { ... }
    method columnNoNulls (--> Int) is export { ... }
    method columnNullable (--> Int) is export { ... }
    method columnNullableUnknown (--> Int) is export { ... }
    method bestRowTemporary (--> Int) is export { ... }
    method bestRowTransaction (--> Int) is export { ... }
    method bestRowSession (--> Int) is export { ... }
    method bestRowUnknown (--> Int) is export { ... }
    method bestRowNotPseudo (--> Int) is export { ... }
    method bestRowPseudo (--> Int) is export { ... }
    method versionColumnUnknown (--> Int) is export { ... }
    method versionColumnNotPseudo (--> Int) is export { ... }
    method versionColumnPseudo (--> Int) is export { ... }
    method importedKeyCascade (--> Int) is export { ... }
    method importedKeyRestrict (--> Int) is export { ... }
    method importedKeySetNull (--> Int) is export { ... }
    method importedKeyNoAction (--> Int) is export { ... }
    method importedKeySetDefault (--> Int) is export { ... }
    method importedKeyInitiallyDeferred (--> Int) is export { ... }
    method importedKeyInitiallyImmediate (--> Int) is export { ... }
    method importedKeyNotDeferrable (--> Int) is export { ... }
    method typeNoNulls (--> Int) is export { ... }
    method typeNullable (--> Int) is export { ... }
    method typeNullableUnknown (--> Int) is export { ... }
    method typePredNone (--> Int) is export { ... }
    method typePredChar (--> Int) is export { ... }
    method typePredBasic (--> Int) is export { ... }
    method typeSearchable (--> Int) is export { ... }
    method tableIndexStatistic (--> Int) is export { ... }
    method tableIndexClustered (--> Int) is export { ... }
    method tableIndexHashed (--> Int) is export { ... }
    method tableIndexOther (--> Int) is export { ... }
    method attributeNoNulls (--> Int) is export { ... }
    method attributeNullable (--> Int) is export { ... }
    method attributeNullableUnknown (--> Int) is export { ... }
    method sqlStateXOpen (--> Int) is export { ... }
    method sqlStateSQL (--> Int) is export { ... }
    method sqlStateSQL99 (--> Int) is export { ... }
    method functionColumnUnknown (--> Int) is export { ... }
    method functionColumnIn (--> Int) is export { ... }
    method functionColumnInOut (--> Int) is export { ... }
    method functionColumnOut (--> Int) is export { ... }
    method functionReturn (--> Int) is export { ... }
    method functionColumnResult (--> Int) is export { ... }
    method functionNoNulls (--> Int) is export { ... }
    method functionNullable (--> Int) is export { ... }
    method functionNullableUnknown (--> Int) is export { ... }
    method functionResultUnknown (--> Int) is export { ... }
    method functionNoTable (--> Int) is export { ... }
    method functionReturnsTable (--> Int) is export { ... }
